...
const Home: NextPage = () => {
  ...
  return (
    ...
    <div className='space-y-5 md:space-y-0 m-5 md:flex md:flex-row items-start justify-center md:space-x-5'>
      ...
      <div className='stats-container space-y-2'>
        <div className="stats-container">
          ...
          px-10 py-5 rounded-md font-semibold text-white shadow-xl 
    ...
    <footer className='border-t border-emerald-500/20 flex items-center text-white justify-between p-5'>
      ...
      DISCLAIMER: This website is made for informational and educational
          ...
          this website content. If you are gambling online utilizing
          information from this website, you are doing so completely and
